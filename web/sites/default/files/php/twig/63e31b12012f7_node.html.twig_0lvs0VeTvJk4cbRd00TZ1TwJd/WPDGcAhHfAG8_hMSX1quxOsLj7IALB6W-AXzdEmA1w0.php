...
/* themes/droopaliness/templates/content/node.html.twig */
class __TwigTemplate_0dfa8eaeea27817ca0b4d9b449008a37 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("droopaliness/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/droopaliness/templates/content/node.html.twig";
    }
...
%}
{{ attach_library('droopaliness/node') }}
...
", "themes/droopaliness/templates/content/node.html.twig", "/var/www/html/web/themes/droopaliness/templates/content/node.html.twig");
    }
